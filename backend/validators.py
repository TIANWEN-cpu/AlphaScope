...
def _normalize_evidence(value: Any, max_items: int = 6) -> List[Dict[str, str]]:
    ...
    for raw in value:
        if isinstance(raw, dict):
            ...
            claim = _safe_str(raw.get("claim") or raw.get("text") or raw.get("content"), max_len=180)
...
if __name__ == "__main__":
    # 自测
    samples = [
        {"signal": "买入", "confidence": 200, "reason": "x", "evidence": [{"type": "fund_flow", "claim": "主力净流入"}]},
