# AI-Finance｜Multi-Agent Financial Research Workbench
...
[![Tests](https://img.shields.io/badge/tests-886%20passed-brightgreen)](tests)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Release](https://img.shields.io/badge/release-v1.4.1-blue)](https://github.com/TIANWEN-cpu/AI--FINANCE/releases/tag/v1.4.1)

AI-Finance 是一个本地优先的 AI 金融研究与量化分析工作台。项目把行情、新闻、公告、财务指标、技术分析、多 Agent 研究、证据链、研究报告、量化回测、基金定投和组合管理整合到一个可运行、可测试、可扩展的工程系统中。
...
![AI-Finance 股票工作台](docs/assets/v1.4.1/workbench.png)

### 数据源终端

![AI-Finance 数据源终端](docs/assets/v1.4.1/news-terminal.png)

### 研究报告生成

![AI-Finance 研究报告生成器](docs/assets/v1.4.1/report-generator.png)
...
- Backend tests: `886 passed, 2 skipped`
