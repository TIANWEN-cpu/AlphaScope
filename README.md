...
[![Release](https://img.shields.io/badge/release-v1.7.1-blue)](https://github.com/TIANWEN-cpu/AlphaScope/releases/tag/v1.7.1)
...
1. 打开 [GitHub Releases](https://github.com/TIANWEN-cpu/AlphaScope/releases/tag/v1.7.1)。
...
| 版本 | 日期 | 重点 |
|------|------|------|
| v1.7.1 | 2026-06-04 | 已知问题修复、通用上传安全、搜索 Enter 解析、全 Agent 失败语义、股票池 CSV 导出、首屏图表告警修复、一键启动便携版验证 |
