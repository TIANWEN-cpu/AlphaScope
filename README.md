...
[![Release](https://img.shields.io/badge/release-v1.7.2-blue)](https://github.com/TIANWEN-cpu/AlphaScope/releases/tag/v1.7.2)
...
1. 打开 [GitHub Releases](https://github.com/TIANWEN-cpu/AlphaScope/releases/tag/v1.7.2)。
