...
[![Release](https://img.shields.io/badge/release-v1.1.2-blue)](https://github.com/TIANWEN-cpu/AI--FINANCE/releases/tag/v1.1.2)
...
- v1.1.1: 量化回测引擎后端 — 策略管理、回测引擎、风控系统（参考 jin-ce-zhi-suan 架构）
- v1.1.2: 回测前端完善 — 连接后端 API、策略工坊、权益曲线、实盘比对
- v1.1.3: 组合管理 & 基金定投 — Portfolio CRUD、基金搜索、定投模拟器
- v1.1.4: 报告生成 & 证据链 — AI 报告模板、证据链图谱可视化、增强新闻面板
