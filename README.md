...
[![Release](https://img.shields.io/badge/release-v1.4.2-blue)](https://github.com/TIANWEN-cpu/AlphaScope/releases/tag/v1.4.2)
...
v1.4.2 是品牌迁移与本地体验稳定性补丁。项目正式更名为 **研策中枢 AlphaScope**，仓库地址迁移到 `https://github.com/TIANWEN-cpu/AlphaScope`；同时修复真实浏览器体验中暴露的本地回测、新闻模块和系统设置问题。

### 品牌与仓库迁移

- README、前端 README、用户手册和部署文档的项目名迁移为研策中枢 AlphaScope。
- CI、Release、clone、Issues 链接迁移到 `TIANWEN-cpu/AlphaScope`。
