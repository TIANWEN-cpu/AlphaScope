...
[![Release](https://img.shields.io/badge/release-v1.7.3-blue)](https://github.com/TIANWEN-cpu/AlphaScope/releases/tag/v1.7.3)
...
1. 打开 [GitHub Releases](https://github.com/TIANWEN-cpu/AlphaScope/releases/tag/v1.7.3)。
